...
- **Validación de Resumen:** 
    - El test debe verificar que se devuelven volúmenes correctos agrupados por tipo.
...
- **Métrica de Calidad:** La ejecución de `pytest --cov` debe reflejar una cobertura igual o superior al 75%. (Alcanzado: 93%)
...
| :--- | :--- | :--- |
| **TK-006-01** | Crear `tests/test_resumen.py` | Hecho |
| **TK-006-02** | Escribir `test_resumen_con_datos` y `test_resumen_sin_datos` | Hecho |
| **TK-006-03** | Crear `tests/test_alertas.py` | Hecho |
| **TK-006-04** | Escribir `test_alertas_sin_superar_umbral` | Hecho |
| **TK-006-05** | Escribir `test_alertas_con_umbral_superado` | Hecho |
| **TK-006-06** | Ejecutar `pytest --cov=. --cov-report=term-missing` y revisar cobertura | Hecho |
