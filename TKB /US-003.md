...
|--------|--------|--------|
| **TK-003-01** | Crear routes/alertas.py con router FastAPI|Hecho|
| **TK-003-02** | Implementar GET /alertas llamando a calcular_alertas(db)|Hecho|
| **TK-003-03** | Definir schema AlertaResponse con Pydantic|Hecho|
| **TK-003-04** | Registrar el router en main.py con prefijo /alertas |Hecho|
| **TK-003-05** | Probar en /docs con datos que superen y no superen umbrales|Hecho|